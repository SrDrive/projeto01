...
public:
    ...
    ImageProcessorWrapper() {
        ...
        // Always create CudaProcessor instance; it provides CPU fallback when CUDA is not available
    ...
    System::Drawing::Bitmap^ ApplyBW_CPU(System::Drawing::Bitmap^ inputBitmap) {
        return ApplyBW_CPU_Impl(inputBitmap);
    }
    System::Drawing::Bitmap^ ApplySepia_CPU(System::Drawing::Bitmap^ inputBitmap) {
        return ApplySepia_CPU_Impl(inputBitmap);
    }
    System::Drawing::Bitmap^ ApplyInvert_CPU(System::Drawing::Bitmap^ inputBitmap) {
        return ApplyInvert_CPU_Impl(inputBitmap);
    }

    // CUDA implementations (runtime fallback to CPU if CUDA not available)
    System::Drawing::Bitmap^ ApplyBW_CUDA(System::Drawing::Bitmap^ inputBitmap) {
        if (nativeCudaProcessor != nullptr) {
            return ApplyBW_CUDA_Impl(inputBitmap);
        }
    ...
    System::Drawing::Bitmap^ ApplySepia_CUDA(System::Drawing::Bitmap^ inputBitmap) {
        if (nativeCudaProcessor != nullptr) {
            return ApplySepia_CUDA_Impl(inputBitmap);
        }
        // fallback to CPU implementation
        return ApplySepia_CPU_Impl(inputBitmap);
    }
    System::Drawing::Bitmap^ ApplyInvert_CUDA(System::Drawing::Bitmap^ inputBitmap) {
        if (nativeCudaProcessor != nullptr) {
            return ApplyInvert_CUDA_Impl(inputBitmap);
        }
        // fallback to CPU implementation
        return ApplyInvert_CPU_Impl(inputBitmap);
    }
...
private:
    ...
    System::Drawing::Bitmap^ ApplyBW_CPU_Impl(System::Drawing::Bitmap^ inputBitmap) {
        int w,h,channels;
    ...
    System::Drawing::Bitmap^ ApplySepia_CPU_Impl(System::Drawing::Bitmap^ inputBitmap) {
        int w,h,channels;
        unsigned char* inBuf = BitmapToBuffer(inputBitmap, w, h, channels);
        unsigned char* outBuf = new unsigned char[w * h * channels];
        for (int i = 0; i < w * h; ++i) {
    ...
    System::Drawing::Bitmap^ ApplyInvert_CPU_Impl(System::Drawing::Bitmap^ inputBitmap) {
        int w,h,channels;
        unsigned char* inBuf = BitmapToBuffer(inputBitmap, w, h, channels);
        unsigned char* outBuf = new unsigned char[w * h * channels];
        for (int i = 0; i < w * h; ++i) {
    ...
    System::Drawing::Bitmap^ ApplyBW_CUDA_Impl(System::Drawing::Bitmap^ inputBitmap) {
        int w,h,channels;
        unsigned char* inBuf = BitmapToBuffer(inputBitmap, w, h, channels);
        unsigned char* outBuf = new unsigned char[w * h * channels];
    ...
    System::Drawing::Bitmap^ ApplySepia_CUDA_Impl(System::Drawing::Bitmap^ inputBitmap) {
        int w,h,channels;
        unsigned char* inBuf = BitmapToBuffer(inputBitmap, w, h, channels);
        unsigned char* outBuf = new unsigned char[w * h * channels];
    ...
    System::Drawing::Bitmap^ ApplyInvert_CUDA_Impl(System::Drawing::Bitmap^ inputBitmap) {
        int w,h,channels;
        unsigned char* inBuf = BitmapToBuffer(inputBitmap, w, h, channels);
        unsigned char* outBuf = new unsigned char[w * h * channels];
